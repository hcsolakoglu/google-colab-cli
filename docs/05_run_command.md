---
log:
2026-09-24: `--env` values are still injected into the remote process but are redacted from persisted execution history; environment variable names remain visible for diagnostics.
